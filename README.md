# Godot Open Editors for Godot 4.7+
...
To install this add-on, look for it in the Godot asset store. Or you can download this repository and copy the addons/open_editors folder to your project.
